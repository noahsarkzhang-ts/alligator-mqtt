 ...
 */
public class InflightResenderHandler extends ChannelDuplexHandler {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(InflightResenderHandler.class);
    ...
    public InflightResenderHandler(long writerIdleTime, TimeUnit unit) {
        if (unit == null) {
